...
@section('main')
    <div id="nobroken">
        <section id="nobroken"class="categorias">
          ...
          <article class="boton">
              <a class="btn btn-outline-dark" href="/registrar" role="button">Ver más</a>
          </article>
      </section>
      <section class="ranking">
          ...
          <article class="posiciones">
              <ol>
                  <li><img src="{{asset('img\1puesto.png')}}" alt=""><a href="/registrar">Usuario 1</a></li>
                  <li><img src="{{asset('img\2puesto.png')}}" alt=""><a href="/registrar">Usuario 2</a></li>
                  <li><img src="{{asset('img\3puesto.png ')}}" alt=""><a href="/registrar">Usuario 3</a></li>
                  <li><img src="{{asset('img\laurel.png')}}" alt=""><a href="/registrar">Usuario 4</a></li>
                  <li><img src="{{asset('img\laurel.png')}}" alt=""><a href="/registrar">Usuario 5</a></li>
              </ol>@else
                    @foreach ($categorias as $categoria)
